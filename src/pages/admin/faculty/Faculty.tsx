                    ...
                    faculties.map((faculty: facultySchema, facultyIndex) => {
                        return (
                            <tr key={faculty._id} className="bg-lightColor dark:bg-gray-800">
                                ...
                                <ActionTd hasView hasEdit hasArchive isHidden={faculty.isHidden} handleView={() => navigate(`/admin/faculty/view/${faculty._id}`)} handleEdit={() => navigate(`/admin/faculty/edit/${faculty._id}`)} handleArchive={() => {
