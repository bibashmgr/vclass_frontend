...
const ListLayout = ({ children, tableHeader, layoutTitle, layoutSubtitle, isEmpty, isLoading }: propsType) => {
    ...
    return (
        <div className='shadow-light dark:shadow-none rounded-lg bg-lightColor dark:bg-gray-800 px-6 py-6'>
                            ...
                            isLoading ? (
                                <tr className="bg-white dark:bg-gray-800">
                                    <td colSpan={tableHeader.length + 2} className='py-4'>
                                        <div role="status" className="animate-pulse flex flex-col gap-4 w-full">
                                ...
                                <tr className="bg-white dark:bg-gray-800">
                                    <td colSpan={tableHeader.length + 2} className='py-4'>
                                        <div className='w-full py-6 flex flex-col gap-4 justify-center items-center'>
                                            <img src={getColorMode() === 'dark' ? '/images/empty-content-dark.svg' : '/images/empty-content-light.svg'} alt="No data" className='w-[150px] h-[150px]' />
