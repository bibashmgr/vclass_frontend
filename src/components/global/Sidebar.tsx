...
const NavLink = ({ title, url, Icon, isActive, closeSidebar, isSidebarOpen }: { title: string, url: string, Icon: IconType, isActive: boolean, closeSidebar: Function, isSidebarOpen: boolean }) => {
